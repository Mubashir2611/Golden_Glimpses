...
const LandingPage = () => {  const navigate = useNavigate();
  const { isAuthenticated, login, register, user, logout } = useAuth();
    // Background images for the vertical slider (FIXED PATHS)
  const backgroundImages = [
    'http://localhost:5174/assests/images/slides.jpg',
    'http://localhost:5174/assests/images/slides2.jpg',
    'http://localhost:5174/assests/images/slides3.jpg'
  ];
  ...
  return (
    <div className="min-h-screen w-full relative">      {/* Vertical Background Slider */}
      ...
      {/* Main Content Area - Just empty space with background slider */}
      <div 
      ...
      >
        {/* Empty content area - just enjoy the sliding background */}
      </div>
