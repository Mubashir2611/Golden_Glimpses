            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  >
                    <MenuItem value="dark" onClick={() => document.body.setAttribute('data-theme', 'dark')}>Dark</MenuItem>
                    <MenuItem value="light" onClick={() => document.body.setAttribute('data-theme', 'light')}>Light</MenuItem>
