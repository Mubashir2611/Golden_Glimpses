...
const LandingPage = () => {  const navigate = useNavigate();
  ...
  const backgroundImages = [
    '/assests/images/slides.jpg',
    '/assests/images/slides2.jpg',
    '/assests/images/slides3.jpg'
  ];
          ...
          <Box
            ...
            >
              ...
              >
                ...
                Lock them away until the perfect moment to rediscover.
              </Typography>
            </motion.div>
            ...
            >
              <Box sx={{ 
                ...
                {[
                  { icon: '📸', text: 'Photo Memories' },
                  { icon: '🎬', text: 'Video Moments' },
                  { icon: '✏️', text: 'Personal Notes' },
