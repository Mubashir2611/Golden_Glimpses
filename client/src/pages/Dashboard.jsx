                  ...
                  >
                    ...
                    <CardContent sx={{ flexGrow: 1, p: 2 }}>
                      ...
                      <Typography variant="body2" color="text.secondary" sx={{ mb: 2, color: 'rgba(255,255,255,0.7)' }}>
                        ...
                        <AccessTimeIcon sx={{ fontSize: 16, color: capsule.status === 'unlocked' ? 'rgba(16, 185, 129, 0.8)' : 'rgba(255,255,255,0.5)', mr: 0.5 }} />
                        <Typography 
                          variant="caption" 
                          sx={{ 
                            color: capsule.status === 'unlocked' 
                              ? 'rgba(16, 185, 129, 0.8)' 
                      ...
                      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.5)' }}>
                          ...
                          <Link to={`/capsules/${capsule.id}`} style={{ textDecoration: 'none' }}>
                            <IconButton 
                              size="small" 
                              sx={{ 
                                color: 'primary.main', 
